...
const TeamTable = ({
  ...
  const options = ["Edit User", "Deactivate User", "Delete User"];

  const tableHeading = [
    { title: "Name", type: "text" },
    { title: "Date added", type: "text" },
                  ...
                  <td class="px-4 py-5 text-[14px]  text-gray-900 align-top lg:align-middle whitespace-nowrap">
                    <div class="flex items-center h-[40px] relative gap-3">
                      <img
                        ...
                        alt=""
                        className="h-full w-[40px] rounded-full object-cover"
                      />
                      <div className="flex flex-col text-14px">
                        <p className="text-brandBlack">{`Jaydon Korsgaard`}</p>
                        <p className="text-textGrey2">{`jaydonkorsgaard@email.com`}</p>
                      </div>
                    </div>
                    <div class="mt-1 space-y-2 pl-11 lg:hidden">
                      {[
                        { value: "Apr 12, 2023", type: "text" },
                        { value: "Guest", type: "button" },
