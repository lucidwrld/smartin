    ...
    <div className="bg-white border rounded-lg p-6">
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            {status === "active" ? <XCircle className="w-4 h-4" /> : <CheckCircle className="w-4 h-4" />}
          </button>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between text-sm text-gray-500">
        <span>Sale Period: {formatDate(sale_start_date)} - {formatDate(sale_end_date)}</span>
...
const TicketingManagementTab = ({ event }) => {
    ...
    setOrders([
      {
        ...
        tickets: [
          { ticket_id: "ticket_1", ticket_name: "General Admission", quantity: 2, price: 99.99 }
        ],
        total_amount: 199.98,
        currency: "USD",
        status: "completed",
      ...
      },
      {
        ...
        tickets: [
          { ticket_id: "ticket_2", ticket_name: "VIP Access", quantity: 1, price: 299.99 }
        ],
        total_amount: 299.99,
        currency: "USD",
        status: "completed",
      ...
      },
      {
        ...
        tickets: [
          { ticket_id: "ticket_3", ticket_name: "Student Discount", quantity: 1, price: 49.99 }
        ],
        total_amount: 49.99,
        currency: "USD",
        status: "pending",
  ...
  // Calculate stats
  const totalRevenue = tickets.reduce((sum, ticket) => sum + (ticket.revenue || 0), 0);
  const totalSold = tickets.reduce((sum, ticket) => sum + ticket.sold, 0);
  const totalAvailable = tickets.reduce((sum, ticket) => sum + (ticket.quantity - ticket.sold), 0);
                ...
                return (
                  <div key={ticket.id}>
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span>{ticket.sold}/{ticket.quantity} ({soldPercentage.toFixed(1)}%)</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div 
            ...
            <div className="p-6">
              ...
              <form className="space-y-4">
                ...
                <div className="flex gap-3 pt-4">
                  <CustomButton
                    buttonText={editingTicket ? "Update Ticket" : "Create Ticket"}
                    buttonColor="bg-purple-600"
                    radius="rounded-md"
                    onClick={() => {
